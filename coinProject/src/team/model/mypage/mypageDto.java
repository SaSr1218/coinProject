...
public class mypageDto {
	...
	private int aName;		// 계좌 멤버이름	- mNo를 통해 mNo를 fk키로 쓰고 있는 acc 정보 중 accName을 가져오려함.
	...
	public mypageDto(int aNo, int aName, int aAccount, int aBalance, int mNo) {
		super();
		this.aNo = aNo;
		this.aName = aName;
	...
	public void setaName(int accName) {
		this.aName = aName;
	}
	...
	public String toString() {
		return "mypageDto [aNo=" + aNo + ", aName=" + aName + ", aAccount=" + aAccount + ", aBalance=" + aBalance
				+ ", mNo=" + mNo + "]";
	}
